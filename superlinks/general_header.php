...
<?php if ($oper_mode == OPER_MODE_NATIVE) { ;?>
	...
	<tr height="2" colspan="2" bgcolor="#183c8f" class="noprint" style="height:2px;">
		<td colspan="2">
			<img src="<?php echo $config['url_path']; ?>images/transparent_line.gif" style="height:2px;" width="170" height="2" border="0"><br>
		</td>
	</tr>
